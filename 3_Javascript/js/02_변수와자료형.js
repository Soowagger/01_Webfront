...
console.log(1234);
console.log("문자열은 양쪽에 쌍따옴표 작성해야 한다!");
...
console.log("nuber1의 값 : " + number1); 
console.log("nuber1의 값 : " + number2);
console.log("100" + 100);
...
number3 = 500; // 기존 변수 number3에 새로운 값만 대입 가능
...
console.log("nubmers : ", numbers, typeof numbers);
