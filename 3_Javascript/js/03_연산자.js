...
function modFn() {
    ...
    console.log("두 수의 나머지 : ", Number(value1) % Number(value2));
}
...
function check() {
    ...
    console.log("++count : ", ++count); // 101 출력
    console.log("++count : ", ++count); // 102 출력
    console.log("++count : ", ++count); // 103 출력
    console.log("++count : ", --count); // 102 출력
    console.log("++count : ", --count); // 101 출력
    console.log("++count : ", --count); // 100 출력
    ...
    console.log("후위 연산 후 count++ : ", count); // 51 출력
...
//     const user = {이름 : name, 나이 : age, 성별 : gender};    
